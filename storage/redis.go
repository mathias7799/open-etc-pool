...
func (r *RedisClient) WriteAcceptedShare(login string, share string) error {
	r.client.ZRemRangeByScore(r.formatKey("acceptedShare", login), "-inf", strconv.FormatInt(time.Now().Add(time.Hour * -24).Unix(), 10))
	...
	r.client.ZRemRangeByScore(r.formatKey("shareNum", login), "-inf", strconv.FormatInt(time.Now().AddDate(0, 0, -24).Unix(), 10))
...
func (r *RedisClient) WriteStaleShare(login string, share string) error {
	r.client.ZRemRangeByScore(r.formatKey("staleShare", login), "-inf", strconv.FormatInt(time.Now().Add(time.Hour * -24).Unix(), 10))
...
func (r *RedisClient) WriteInvalidShare(login string, share string) error {
	r.client.ZRemRangeByScore(r.formatKey("invalidShare", login), "-inf", strconv.FormatInt(time.Now().Add(time.Hour * 24).Unix(), 10))
...
func (r *RedisClient) WriteDuplicateShare(login string, share string) error {
	r.client.ZRemRangeByScore(r.formatKey("duplicateShare", login), "-inf", strconv.FormatInt(time.Now().Add(time.Hour * -24).Unix(), 10))
...
func (r *RedisClient) GetShareRatio(login string) [4]int {
    oneHourAgo := strconv.FormatInt(time.Now().Add(time.Hour * -24).Unix(), 10)
